<template>
  <div class="contentwrapper">
    <v-container
      :style="{'background-image': 'url(' + require('@/assets/pictures/newmain.jpg') + ')'}"
      fluid
      class="jarallax text-xs-center pa-0 main-image"
      style="height:100%;height:100vh;"
    >
      <div
        style="position:absolute;top:0;left:0;height:100%;width:100%;backgroundColor:black;opacity: 0.35;
  filter: alpha(opacity=35);"
      ></div>
      <v-layout style="height:100%" align-center justify-center>
        <v-flex class="white--text" xs12 md10>
          <div class="animated fadeInUp main-one mb-5">
            승희
            <small>그리고</small> 경민
          </div>
        ...
        <v-flex xs12 md6>
          <v-card data-scroll>
            <v-container pa-2 fluid grid-list-md>
              <v-layout row wrap>
                <v-flex v-for="(picture,index) in pictures" :key="index" xs6>
                  <v-card style="position:relative;" flat tile>
                    <v-img :src="picture.src" height="150px"></v-img>
                    <div @click.stop="$router.push('gallery')" v-if="index==3" class="more-photoes">
                      <div class="text-xs-center" style="color:white; font-size:16px;">사진 더 보기 +</div>
                    </div>
                  </v-card>
                </v-flex>
              </v-layout>
...
export default {
  ...
  data() {
    return {
      ...
      pictures: [
        {
          src: require("@/assets/photoes/gallery2.jpg")
        },
        {
          src: require("@/assets/photoes/gallery3.jpg")
        },
        {
          src: require("@/assets/photoes/gallery4.jpg")
        },
        {
          src: require("@/assets/photoes/gallery5.jpg")
        }
        // {
